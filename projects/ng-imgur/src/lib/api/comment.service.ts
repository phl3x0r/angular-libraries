...
export class CommentService {
   ...
   */
  public commentByCommentIdDelete(
    commentId: string,
    observe?: 'body',
  ...
  public commentByCommentIdDelete(
    ...
    if (commentId === null || commentId === undefined) {
      throw new Error(
        'Required parameter commentId was null or undefined when calling 3CommentByCommentIdDelete.'
      );
    }
    ...
    return this.httpClient.delete<any>(
      `${this.basePath}/3/comment/${encodeURIComponent(String(commentId))}`,
      {
  ...
  /**
   * Comment
   * Get information about a specific comment.  #### Response Model: [Comment](https://api.imgur.com/models/comment)
   * @param commentId
   * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
   * @param reportProgress flag to report request and response progress.
   */
  public commentByCommentIdGet(
    commentId: string,
    observe?: 'body',
    reportProgress?: boolean
  ): Observable<any>;
  ...
  public commentByCommentIdGet(
    ...
    if (commentId === null || commentId === undefined) {
      throw new Error(
        'Required parameter commentId was null or undefined when calling 3CommentByCommentIdGet.'
      );
    }
  ...
  /**
   * Reply Creation
   * Create a reply for the given comment.  #### Response Model: [Basic](https://api.imgur.com/models/basic)  #### Parameters  | Key      | Required | Description                                                    | |----------|----------|----------------------------------------------------------------| | image_id | required | The ID of the image or album in the gallery that you wish to comment on | | comment  | required | The comment text, this is what will be displayed               |
   * @param imageId
   * @param comment
   * @param commentId
   * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
  ...
  public commentByCommentIdPost(
    ...
    if (imageId === null || imageId === undefined) {
      throw new Error(
        'Required parameter imageId was null or undefined when calling 3CommentByCommentIdPost.'
      );
    }
    if (comment === null || comment === undefined) {
      throw new Error(
        'Required parameter comment was null or undefined when calling 3CommentByCommentIdPost.'
      );
    }
    if (commentId === null || commentId === undefined) {
      throw new Error(
        'Required parameter commentId was null or undefined when calling 3CommentByCommentIdPost.'
      );
    }
  ...
  /**
   * Comment Creation
   * Creates a new comment, returns the ID of the comment.  #### Response Model: [Basic](https://api.imgur.com/models/basic)  #### Parameters  | Key       | Required | Description                                                                    | |-----------|----------|--------------------------------------------------------------------------------| | image_id  | required | The ID of the image or album in the gallery that you wish to comment on                 | | comment   | required | The comment text, this is what will be displayed                               | | parent_id | optional | The ID of the parent comment, this is an alternative method to create a reply. |
   * @param imageId
   * @param comment
   * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
   * @param reportProgress flag to report request and response progress.
  ...
  public commentPost(
    ...
    if (imageId === null || imageId === undefined) {
      throw new Error(
        'Required parameter imageId was null or undefined when calling 3CommentPost.'
      );
    }
    if (comment === null || comment === undefined) {
      throw new Error(
        'Required parameter comment was null or undefined when calling 3CommentPost.'
      );
    }
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public commentRepliesByCommentIdGet(
    commentId: string,
    observe?: 'body',
    reportProgress?: boolean
  ): Observable<any>;
  ...
  public commentRepliesByCommentIdGet(
    ...
    if (commentId === null || commentId === undefined) {
      throw new Error(
        'Required parameter commentId was null or undefined when calling 3CommentRepliesByCommentIdGet.'
      );
    }
    ...
    return this.httpClient.get<any>(
      `${this.basePath}/3/comment/${encodeURIComponent(
        String(commentId)
      )}/replies`,
      {
        withCredentials: this.configuration.withCredentials,
   ...
   * @param reason Optional. An integer representing the reason for the report  | Value | Description                         | |-------|-------------------------------------| | 1     | Doesn&#39;t belong on Imgur             | | 2     | Spam                                | | 3     | Abusive                             | | 4     | Mature content not marked as mature | | 5     | Pornography                         |
   * @param commentId
   * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
   * @param reportProgress flag to report request and response progress.
   */
  public commentReportByCommentIdPost(
    reason: string,
    commentId: string,
    observe?: 'body',
    reportProgress?: boolean
  ...
  public commentReportByCommentIdPost(
    ...
    if (reason === null || reason === undefined) {
      throw new Error(
        'Required parameter reason was null or undefined when calling 3CommentReportByCommentIdPost.'
      );
    }
    if (commentId === null || commentId === undefined) {
      throw new Error(
        'Required parameter commentId was null or undefined when calling 3CommentReportByCommentIdPost.'
      );
    }
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public commentVoteByCommentIdAndVotePost(
    commentId: string,
    vote: string,
    observe?: 'body',
    reportProgress?: boolean
  ...
  public commentVoteByCommentIdAndVotePost(
    ...
    if (commentId === null || commentId === undefined) {
      throw new Error(
        'Required parameter commentId was null or undefined when calling 3CommentVoteByCommentIdAndVotePost.'
      );
    }
    if (vote === null || vote === undefined) {
      throw new Error(
        'Required parameter vote was null or undefined when calling 3CommentVoteByCommentIdAndVotePost.'
      );
    }
